...
const arrayTextoSobreNos = [
    {
        primeiroParagrafo: 'O <a target="_blank" href="index.html"><strong class="nome-jornal-grifado">Grid da Notícia</strong></a> é um site indexador de notícias, desenvolvido por estudantes de tecnologia, que tem o objetivo de trazer as principais informações sobre: <a href="culinaria.html">Culinária</a>, <a href="espaco_sideral.html">Espaço Sideral</a> e <a href="tecnologia.html">Tecnologia</a>.',
    },

    {
        segundoParagrafo: 'O nosso principal propósito, é o de promover um site que seja adaptável, seguro e acessível, onde vocês possam se informar das principais notícias dos temas que temos disponíveis, sem se preocupar com as "fake news", nós não tratamos nossos apoiadores como produtos, por isso, muito mais vale seriedade e credibilidade do que "clicks".',
    },
] 
...
const arrayCardsSobreNos = [
...

    {
        ...
        altImg: '',
        titleCard: 'Seguro:',
        descriptionCard: 'O Grid da Notícia é <strong>seguro</strong>, exatamente por prezar pela seriedade e credibilidade do que por "clicks". <br> <br> Até nossos parceiros publicitários passam por um rigoroso processo de aprovação, para poderem anunciar conosco, assim como, as notícias que são divulgadas em nossas páginas.',
    },

    {
        ...
        altImg: '',
        titleCard: 'Acessivel:',
        descriptionCard: 'De nada adianta apoiarmos a causa de mais <strong>acessibilidade</strong>, se não fizermos a nossa parte. <br> <br> Por isso, sentimos orgulho de contar com o plug-in de acessibilidade <strong> <a href="https://www.gov.br/governodigital/pt-br/vlibras" target="_blank" rel="noopener noreferrer">VLibras</a></strong> em nosso site.',
    },
...
// Adicionar elemento:
    let sectionCardsSobreNosSomos = document.querySelector('.cards-sobre-nos-somos')
